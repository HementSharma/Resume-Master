...
bio.display = function() {
    ...
    $("#topContacts, #footerContacts").append(HTMLmobile.replace("%data%", bio.contact.mobile) + HTMLemail.replace("%data%", bio.contact.email) + HTMLgithub.replace("%data%", bio.contact.github) + HTMLlocation.replace("%data%", bio.contact.location));
...
education.display = function() {
    ...
    education.schools.forEach(function(school) {
        ...
        school.major.forEach(function(major) {
            HTMLschoolMajorlocal = HTMLschoolMajorlocal + HTMLschoolMajor.replace("%data%", school.major);
        })
    ...
    education.onlineCourses.forEach(function(onlineschool) {
        $("#education").append(HTMLschoolStart);
        HTMLonlineTitlelocal = HTMLonlineTitle.replace("%data%", onlineschool.title);
        HTMLonlineSchoollocal = HTMLonlineSchool.replace("%data%", onlineschool.school);
        HTMLonlineDateslocal = HTMLonlineDates.replace("%data%", onlineschool.dates);
        HTMLonlineURLlocal = HTMLonlineURL.replace("%data%", onlineschool.url);
